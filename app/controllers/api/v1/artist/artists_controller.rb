class Api::V1::Artist::ArtistsController < ApiController
	...
	def all
		...
		data = {
			 playlists: Api::V1::Parser.parse_playlists(p.playlists), albums: Api::V1::Parser.parse_albums(p.not_suspended_albums), songs: Api::V1::Parser.parse_songs(p.songs)
		}
	...
	def profile
		data = {
				playlists: Api::V1::Parser.parse_playlists(current_user.playlists), liked_artists: Api::V1::Parser.parse_artists(current_user.liked_artists), songs: Api::V1::Parser.parse_songs(current_user.liked_songs)
		}
		return render_json_response({:msg => SUCCESS_DEFAULT_MSG, :success => true, data:  data}, :ok)
	end
